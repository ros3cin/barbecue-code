 ...
 * Barcode portlet
 *
 * Note: this portlet uses features from the Portlet 2.0 specification
 * (JSR-286). This portlet will not run in a Portlet 1.0 container.
 * 
...

{
	...
	protected void doEdit(RenderRequest req, RenderResponse resp) throws PortletException, IOException {
	...
	protected void doHelp(RenderRequest req, RenderResponse resp) throws PortletException, IOException {
		resp.setContentType("text/html");
		PrintWriter writer = resp.getWriter();
		writer.println("<a target=\"_blank\" href=\"http://en.wikipedia.org/wiki/Barcode\">What is a barcode?</a>");
	}

	public void processAction(ActionRequest req, ActionResponse resp) throws PortletException, java.io.IOException {
